...
public class Main {
    ...
    public static ArrayList<Pregunta> inicialitzarPreguntes() {
        ...
        preguntes.add(new Pregunta("Quina és la magnitud que relaciona espai i temps", new String[]{"velocitat", "temperatura", "pes"}, 1));
        ...
        preguntes.add(new Pregunta("L'Acropolis es troba a", new String[]{"Atenes", "Roma", "París"}, 2));
